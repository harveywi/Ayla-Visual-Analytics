...
import edu.osu.compgeom.landscapes.floorplan.NoncriticalPointTerrainPos
import edu.osu.compgeom.landscapes.floorplan.CriticalPointTerrainPos
import org.jgrapht.graph._
import javax.swing.JPopupMenu
import javax.swing.JMenuItem
import java.awt.event.ActionListener
import edu.osu.compgeom.omegavis.JmolPanel
import javax.media.j3d._
import com.sun.j3d.utils.geometry.Sphere
import edu.osu.compgeom.omegavis.event.TerrainSpheresReady
        ...
        if (myIndex != 0 && myIndex < storyboardEditor.contents.size - 1) {
          ...
          sources.foreach { source =>
            sinks.foreach { sink =>
              ...
              assert(floorplan.terrainGraph.containsVertex(source))
              assert(floorplan.terrainGraph.containsVertex(sink))
