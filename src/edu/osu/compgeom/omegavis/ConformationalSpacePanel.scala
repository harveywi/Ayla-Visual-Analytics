...
import edu.osu.compgeom.omegavis.event.TopologicalComponentManagerSelectionUpdate
...
import edu.osu.compgeom.ayla.collab.CreateConformationAnnotationDialog
import javax.swing.OverlayLayout
import java.awt.BorderLayout
import edu.osu.compgeom.omegavis.event.SetS1
    ...
    override def paint(g2d: Graphics2D): Unit = {
      ...
      selectedConformations.foreach(c => {
        ...
        val color = try { tcManager.colormap.getColor(stateManager.colorFunction.getFuncVal(c.conformationID)) } catch {
          case _ => new javax.vecmath.Color4f(1f, 1f, 1f, 1f)
        }
